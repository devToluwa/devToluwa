...
Automated AWS infra deployment using Terraform, featuring VPC networking and an EC2 Instance.
...
CI/CD pipeline for a Node.js app using GitHub Actions and Docker
